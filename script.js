...
const I18N = {
  ja: {
    ...
    disclaimer_ip_body: "『FULL STRIDE』の名称は、開発元に帰属する商標です。本サイトで紹介する競走馬の名称は実在の史実競走馬名であり、特定の権利者に帰属するものではありませんが、各馬に設定されたステータス値・成長曲線・推定価格の算出根拠等、ゲーム独自の評価データは開発元が創作したものであり、開発元に帰属します。JRA・地方競馬関連団体の名称、競走名等についても、それぞれの権利者に帰属します。",
    disclaimer_history_title: "掲載する史実情報について",
    disclaimer_history_body: "各馬の史実紹介（ミニコラム）は、Wikipedia・JBIS（軽種馬改良情報システム、公益社団法人日本軽種馬協会運営）等の公開資料をもとに、当サイト運営者が独自に要約・再構成したものであり、各情報源の文章をそのまま転載するものではありません。内容は独自調査に基づくものであり、正確性・完全性を保証するものではなく、予告なく変更・修正・削除される場合があります。推定価格についても同様に独自調査による目安であり、ゲーム内の実際の値と異なる場合があります。",
    disclaimer_people_title: "実在の人物・団体への言及について",
    disclaimer_people_body: "本サイトが紹介する競走馬の史実には、騎手・調教師・馬主・生産者等、実在の方々のお名前が登場しますが、これらはいずれも公開されているレース結果・報道等に基づく事実の紹介であり、いかなる方・団体の名誉を毀損する意図もありません。もし記載内容に誤りがある、または訂正・削除を希望される場合は、下記お問い合わせ先までご連絡ください。事実確認のうえ、真摯に対応いたします。",
    disclaimer_gambling_title: "賭博行為との関係について",
    disclaimer_gambling_body: "本サイトは競走馬の検索・史実紹介を目的としたツールであり、馬券の購入その他の賭博行為を推奨するものではなく、またいかなる賭博行為とも一切関係ありません。",
    disclaimer_data_title: "データの取り扱いについて",
    disclaimer_data_body: "マイ厩舎等、本サイト上で保存される機能はお使いの端末内にのみ保存され、外部のサーバーには送信されません。なお、アクセス状況の把握のため外部のアクセスカウンターサービスを利用しており、その際にアクセス元の情報が当該サービスに送信されます。",
    ...
    disclaimer_dates: "制定日：2026年7月16日／最終改訂日：2026年9月7日（第1回改訂）",
  ...
  en: {
    ...
    disclaimer_ip_body: "The name \"FULL STRIDE\" is a trademark belonging to the developer. The names of racehorses featured on this site are the actual names of real-world racehorses and are not the property of any specific rights holder. However, the in-game evaluation data assigned to each horse — including stat values, growth curves, and the basis for estimated prices — is original data created by the developer and remains the developer's property. The names of the JRA, local racing associations, and race names also belong to their respective rights holders.",
    disclaimer_history_title: "Historical Information Presented",
    disclaimer_history_body: "The real-world profile for each horse (mini-column) is an original summary compiled by the site operator based on public sources such as Wikipedia and JBIS (Japan Bloodstock Information System, operated by the Japan Bloodhorse Breeders' Association), and is not a direct reproduction of any source's text. This content is based on independent research; its accuracy and completeness are not guaranteed, and it may be changed, corrected, or removed without notice. Estimated prices are likewise independent estimates and may differ from actual in-game values.",
    disclaimer_people_title: "References to Real Individuals and Organizations",
    disclaimer_people_body: "The historical profiles on this site mention real individuals — jockeys, trainers, owners, breeders, and others — based on publicly available race results and reporting. There is no intent to defame any individual or organization. If you believe any content is inaccurate, or would like to request a correction or removal, please contact us using the information below. We will verify the matter and respond in good faith.",
    disclaimer_gambling_title: "Relationship to Gambling",
    disclaimer_gambling_body: "This site is a tool for searching and presenting historical profiles of racehorses. It does not encourage the purchase of betting tickets or any other form of gambling, and has no connection whatsoever to such activities.",
    disclaimer_data_title: "Data Handling",
    disclaimer_data_body: "Features such as \"My Stable\" store data only on your own device; nothing is sent to any external server. Separately, this site uses a third-party visitor counter service to track site traffic, and information about the visitor's origin is sent to that service in the process.",
    ...
    disclaimer_dates: "Established: July 16, 2026 / Last revised: September 7, 2026 (1st revision)",
